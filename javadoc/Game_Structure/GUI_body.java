...
public class GUI_body {
	 ...
	 */
	public GUI_body() { 
		Game_Profile = new Game_Profile(1, "Little shit", "Bull shit", 10, 5);		// Set default stats, Testing / Start game in game body dosent do much if game is started from GUI_setup
